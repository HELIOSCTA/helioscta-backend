...
def main(
    ...
    sftp_host: str = credentials.NAV_SFTP_HOST,
    sftp_port: int = credentials.NAV_SFTP_PORT,
    sftp_user: str = credentials.NAV_SFTP_USER,
    sftp_password: str = credentials.NAV_SFTP_PASSWORD,
    sftp_remote_dir: str = credentials.NAV_SFTP_REMOTE_DIR,
):
