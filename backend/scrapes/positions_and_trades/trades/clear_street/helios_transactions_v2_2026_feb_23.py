...
from backend.scrapes.positions_and_trades import (
    settings,
)
...
def main(
    ...
    sftp_host: str = credentials.CLEAR_STREET_SFTP_HOST,
    sftp_port: int = credentials.CLEAR_STREET_SFTP_PORT,
    sftp_user: str = credentials.CLEAR_STREET_SFTP_USER,
    sftp_private_key_path: str = credentials.CLEAR_STREET_SSH_KEY_CONTENT,
    sftp_remote_dir: str = credentials.CLEAR_STREET_SFTP_REMOTE_DIR,
):
