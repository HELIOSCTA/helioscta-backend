...
def main(
    ...
    sftp_host: str = credentials.MAREX_SFTP_HOST,
    sftp_port: int = credentials.MAREX_SFTP_PORT,
    sftp_user: str = credentials.MAREX_SFTP_USER,
    sftp_password: str = credentials.MAREX_SFTP_PASSWORD,
    sftp_remote_dir: str = credentials.MAREX_SFTP_REMOTE_DIR,
):
