# Registers the ICE contract-dates (PJM short-term power) Task Scheduler job.
...
#
# Sibling of the three futures-contract-dates .ps1 files
# (gas / power_ercot / power_pjm), which fire once at 07:00.
#
...
$moduleName  = "backend.orchestration.ice_python.contract_dates.contract_dates_pjm_short_term"
...
Register-ScheduledTask `
    -TaskName "Contract Dates PJM Short Term" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
