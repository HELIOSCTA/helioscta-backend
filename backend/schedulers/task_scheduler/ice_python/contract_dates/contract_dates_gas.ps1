# Registers the ICE contract-dates (gas futures) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.contract_dates.contract_dates_gas"
