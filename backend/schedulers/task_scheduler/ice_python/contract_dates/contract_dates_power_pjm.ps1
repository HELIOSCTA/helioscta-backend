# Registers the ICE contract-dates (PJM power futures) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.contract_dates.contract_dates_power_pjm"
...
Register-ScheduledTask `
    -TaskName "Contract Dates Power PJM" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
