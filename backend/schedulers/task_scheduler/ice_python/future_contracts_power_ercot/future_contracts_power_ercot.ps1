# Registers the ICE future contracts (ERCOT power region) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.future_contracts.future_contracts_power_ercot"
...
Register-ScheduledTask `
    -TaskName "Future Contracts Power ERCOT" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
