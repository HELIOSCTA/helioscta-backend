# Registers the ICE future contracts (gas / rockies_northwest region) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.future_contracts.future_contracts_gas_rockies_northwest"
...
Register-ScheduledTask `
    -TaskName "Future Contracts Gas Rockies Northwest" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
