# Registers the ICE future contracts (gas / northeast region) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.future_contracts.future_contracts_gas_northeast"
...
Register-ScheduledTask `
    -TaskName "Future Contracts Gas Northeast" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
