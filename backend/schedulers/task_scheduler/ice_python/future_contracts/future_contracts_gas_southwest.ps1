# Registers the ICE future contracts (gas / southwest region) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.future_contracts.future_contracts_gas_southwest"
...
Register-ScheduledTask `
    -TaskName "Future Contracts Gas Southwest" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
