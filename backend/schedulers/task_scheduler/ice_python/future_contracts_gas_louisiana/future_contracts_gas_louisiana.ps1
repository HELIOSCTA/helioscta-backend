# Registers the ICE future contracts (gas / louisiana region: Henry Hub) Task Scheduler job.
...
$moduleName  = "backend.orchestration.ice_python.future_contracts.future_contracts_gas_louisiana"
...
Register-ScheduledTask `
    -TaskName "Future Contracts Gas Louisiana" `
    -Action $action `
    -Trigger $trigger `
    -Settings $settings `
