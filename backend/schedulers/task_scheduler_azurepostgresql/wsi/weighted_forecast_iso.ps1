...
$runScript = "C:\Users\AidanKeaveny\Documents\github\helioscta-backend\backend\src\wsi\weighted_forecast_iso\runs.py"
...
Register-ScheduledTask `
    -TaskName "WSI Weighted Forecast ISO Every 6 Hours" `
    -Action $action `
    -Trigger $trigger `
