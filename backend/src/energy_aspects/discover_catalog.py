...
Output: JSON file written to backend/src/energy_aspects/output/catalog.json
...
from backend.src.energy_aspects import energy_aspects_api_utils as ea_api
...
def main():
    ...
    Outputs:
        - backend/src/energy_aspects/output/catalog.json
