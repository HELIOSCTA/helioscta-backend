...
from backend.src.ice_python.symbols.pjm_short_term_symbols import (
...
def _select_symbol_entries(symbols: list[str] | None = None) -> list[dict]:
    ...
    if symbol_entries:
        logger.info(
            ...
            "backend/src/ice_python/symbols/pjm_short_term_symbols.py"
        )
...
def main(
    ...
    symbols : list[str] | None
        ...
        ``backend/src/ice_python/symbols/pjm_short_term_symbols.py`` are processed.
