...
from backend.src.ice_python.symbols.ercot_short_term_symbols import (
    get_ercot_symbol_codes,
    resolve_ercot_symbol_entries,
)
from backend.src.ice_python.intraday_quotes import ice_intraday_quotes_utils
...
def _select_symbol_entries(symbols: list[str] | None = None) -> list[dict]:
    ...
    if symbol_entries:
        logger.info(
            ...
            "backend/src/ice_python/symbols/ercot_short_term_symbols.py"
        )
...
def main(
    ...
    symbols : list[str] | None
        ...
        ``backend/src/ice_python/symbols/ercot_short_term_symbols.py`` are processed.
