...
Usage:
    from backend.src.ice_python.symbols.next_day_gas_symbols import get_next_day_gas_symbols
"""
...
# Symbol registry
# ---------------------------------------------------------------------------
# Source: backend/src/ice_python/next_day_gas/next_day_gas_v1_2025_dec_16.py
