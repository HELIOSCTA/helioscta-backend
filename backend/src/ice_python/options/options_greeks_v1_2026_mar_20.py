...
from backend.src.ice_python.intraday_quotes.ice_intraday_quotes_utils import (
    current_snapshot_at_mst,
    snapshot_at_to_db_value,
    get_quotes_snapshot,
)
from backend.src.ice_python.symbols.options_symbols import (
...
def main(
    ...
    products : list[dict] | None
        ...
        ``backend/src/ice_python/symbols/options_symbols.py``.
    months_forward : int
