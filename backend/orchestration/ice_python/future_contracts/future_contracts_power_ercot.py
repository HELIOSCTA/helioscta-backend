"""ERCOT power slice of the ICE future contracts scrape.
...
Usage (Task Scheduler):
    python -m backend.orchestration.ice_python.future_contracts_power_ercot
"""
...
LABEL = "orchestration_ice_python_future_contracts__power_ercot"


def main() -> int:
    products = [entry["product"] for entry in get_ercot_power_futures_products()]
