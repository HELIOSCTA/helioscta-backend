...
$runScript = "C:\Users\AidanKeaveny\Documents\github\helioscta-backend\backend\src\wsi\homepage_forecast_table\runs.py"
...
Register-ScheduledTask `
    -TaskName "WSI Homepage Forecast Table Every 6 Hours" `
    -Action $action `
    -Trigger $trigger `
